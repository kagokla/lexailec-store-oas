## LEXAILEC online shopping store - OpenAPI Specification
...
2. Run `npm install` in this repository root folder.
...
2. Add a new YAML file named like your URL endpoint except replacing `/` with `@` and putting path parameters into curly
   braces like `{example}`.
